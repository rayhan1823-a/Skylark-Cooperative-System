...
function Reports(){
  ...
  // কোন কার্ডটি সিলেক্ট করা আছে তা ট্র্যাক করার জন্য ফিল্টার স্টেট ("all", "active", "inactive", "exited")
  ...
  // ============================
  const exportExcel = ()=>{
    const data = filteredReport.map((item, index)=>({
      "SL": index + 1,
    ...
    XLSX.writeFile(book, `Skylark-${filterType}-Member-Report.xlsx`);
  };
  ...
  return(
    <div className="space-y-8" id="printArea">
      ...
      <div className="text-center flex flex-col items-center justify-center space-y-3 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div>
          ...
          <h2 className="text-lg font-semibold text-gray-600 mt-1">
            Member Financial Report ({filterType.toUpperCase()})
          </h2>
      ...
      {/* Professional & Premium Summary Cards - 4 cards per row (Clickable for filtering) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div onClick={() => setFilterType("all")} className="cursor-pointer">
          <SummaryCard
            ...
            borderColor={filterType === "all" ? "border-blue-500 ring-2 ring-blue-400" : "border-blue-100"}
          />
        </div>

        <div onClick={() => setFilterType("active")} className="cursor-pointer">
          <SummaryCard
            ...
            borderColor={filterType === "active" ? "border-emerald-500 ring-2 ring-emerald-400" : "border-emerald-100"}
          />
        </div>

        <div onClick={() => setFilterType("inactive")} className="cursor-pointer">
          <SummaryCard
            ...
            borderColor={filterType === "inactive" ? "border-amber-500 ring-2 ring-amber-400" : "border-amber-100"}
          />
        </div>

        <div onClick={() => setFilterType("exited")} className="cursor-pointer">
          <SummaryCard
            title="Exits Member"
            value={exitedMembers}
            ...
            borderColor={filterType === "exited" ? "border-rose-500 ring-2 ring-rose-400" : "border-rose-100"}
          />
        </div>
      ...
      <div className="flex justify-between items-center flex-wrap gap-4 no-print">
        ...
        {filterType !== "all" && (
          <button
            ...
            className="text-sm font-semibold bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-xl transition"
          >
            🔄 Show All Members
          </button>
        )}
            ...
            <tbody>
              {
                filteredReport.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="13" className="text-center p-6 text-gray-500 font-medium">
